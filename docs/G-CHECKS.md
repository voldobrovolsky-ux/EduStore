...
**Пересматриваются:** G-6 (пилотный контур) — её пункт «пилотная сессия несёт форму
claims внешнего OIDC» потерял основание вместе с AR-15; проверка остаётся зелёной и
переформулируется вместе с G-24. Строки реестра, ссылающиеся на снятые ворота
(AR-1, AR-33), сохраняют ссылку: реестр — журнал, а не текущее состояние.
